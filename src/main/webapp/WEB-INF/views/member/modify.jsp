                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">modify</h3></div>
                                    <div class="card-body">
 <div class="form-row">
      <div class="col-md-6">
         <div class="form-group">
<label class="small mb-1">이름</label>
<input class="form-control py-4" type="text" name="name" value="${viewlist.name}"/>
</div>
</div>
...
<input class="form-control py-4" type="text" name="age" value="${viewlist.age}"/>
</div>
</div>
</div>
